...
export default function HeaderProjectDetail({ members, projectName }) {
  const { creator } = useSelector((state) => state.ProjectDetailReducer);
    ...
    <div className="flex justify-between items-center px-8 py-2 ">
      <div className="flex gap-6 items-center">
        ...
        <button
          ...
          className={`glassMorphismButton mx-1 hidden lg:block px-4 py-2 ${
        ...
        <button
          ...
          className={`glassMorphismButton mx-1  px-4 py-2 ${
      ...
      <div className="flex gap-6 items-center ">
        ...
        <div className="flex items-center">
          <span className=" border-blue-300 border-4 rounded-full">
            <img
